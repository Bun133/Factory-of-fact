...
public class Logger extends PrintStream{
	 ...
	 */
	public void setTextColor(int r,int g,int b)throws IllegalArgumentException{
		try {
	 ...
	 * @throws IllegalArgumentException
	 */
	public void setTextColorOnece(int r,int g,int b) throws IllegalArgumentException{
		try {
